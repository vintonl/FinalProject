...
INSERT INTO `address` (`id`, `address`, `address2`, `city`, `state`, `postal_code`, `country`) VALUES (3, '7400 E Orchard Rd #1451n', NULL, 'Greenwood Village', 'Colorado', 80111, 'USA');
INSERT INTO `address` (`id`, `address`, `address2`, `city`, `state`, `postal_code`, `country`) VALUES (4, '7400 E Orchard Rd #1451n', NULL, 'Greenwood Village', 'Colorado', 80111, 'USA');
INSERT INTO `address` (`id`, `address`, `address2`, `city`, `state`, `postal_code`, `country`) VALUES (5, '7400 E Orchard Rd #1452n', NULL, 'Greenwood Village', 'Colorado', 80111, 'USA');
...
INSERT INTO `address` (`id`, `address`, `address2`, `city`, `state`, `postal_code`, `country`) VALUES (7, '7400 E Orchard Rd #1450n', NULL, 'Greenwood Village', 'Colorado', 80111, 'USA');
...
INSERT INTO `address` (`id`, `address`, `address2`, `city`, `state`, `postal_code`, `country`) VALUES (9, '7400 E Orchard Rd #1450n', NULL, 'Greenwood Village', 'Colorado', 80111, 'USA');
...
INSERT INTO `address` (`id`, `address`, `address2`, `city`, `state`, `postal_code`, `country`) VALUES (11, '7400 E Orchard Rd #1450n', NULL, 'Greenwood Village', 'Colorado', 80111, 'USA');
...
START TRANSACTION;
USE `geardb`;
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`, `role`, `image_url`, `about`, `address_id`, `phone`, `enabled`, `username`) VALUES (1, 'gear', 'silo', 'gearsilo@gmail.com', '$2a$10$BKe0NjmOywOYa6s7lux5oe3YsEfwnun5YDXzAVstY1KQTJD8a/vf.', '2019-12-17', '2019-12-17', 'admin', 'sdafasd', 'afdsadf', 1, '(555)555-5555', 1, 'gearsilo@gmail.com');
...
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`, `role`, `image_url`, `about`, `address_id`, `phone`, `enabled`, `username`) VALUES (3, 'Kelly ', 'Slater', 'kellyslater@gmail.com', 'surfsup', '2019-12-18', '2019-12-18', 'user', 'https://i.imgur.com/y6f4lgf.jpg', 'American professional surfer widely considered the greatest surfer of all time.', 3, '(333)333-3333', 1, 'kellyslater@gmail.com');
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`, `role`, `image_url`, `about`, `address_id`, `phone`, `enabled`, `username`) VALUES (4, 'Peyton', 'Manning', 'peytonmanning@gmail.com', 'peyton', '2019-12-18', '2019-12-18', 'user', 'https://i.imgur.com/78VZc9g.jpg', 'Considered to be one of the greatest quarterbacks of all time.', 4, '(222)222-2222', 1, 'peytonmanning@gmail.com');
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`, `role`, `image_url`, `about`, `address_id`, `phone`, `enabled`, `username`) VALUES (5, 'Shaun ', 'White', 'shaunwhite@gmail.com', 'shaunwhite', '2019-12-18', '2019-12-18', 'user', 'https://i.imgur.com/FAGZlWy.jpg', 'Professional snowboarder, skateboarder and musician. He is a three-time Olympic gold medalist', 5, '(111)111-1111', 1, 'shaunwhite@gmail.com');
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`, `role`, `image_url`, `about`, `address_id`, `phone`, `enabled`, `username`) VALUES (6, 'Larry', 'Larry', 'larry@larry.com', 'larry', '2019-12-18', '2019-12-18', 'user', 'https://i.imgur.com/oHjEQpe.png', 'Outdoorsman with tons of sporting equipment.', 6, '(555)555-4444', 1, 'larry@larry.com');
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`, `role`, `image_url`, `about`, `address_id`, `phone`, `enabled`, `username`) VALUES (7, 'Vinton', 'Lee', 'vintonlee@gear.com ', 'gear', '2019-12-18', '2019-12-18', 'user', NULL, NULL, 7, '(555)555-5555', 1, 'vintonlee@gear.com ');
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`, `role`, `image_url`, `about`, `address_id`, `phone`, `enabled`, `username`) VALUES (8, 'Jerry', 'Rogers', 'jerryrogers@gear.com', 'gear', '2019-12-18', '2019-12-18', 'user', NULL, NULL, 8, '(555)555-5555', 1, 'jerryrogers@gear.com');
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`, `role`, `image_url`, `about`, `address_id`, `phone`, `enabled`, `username`) VALUES (9, 'Colt', 'Looper', 'coltlooper@gear.com', 'gear', '2019-12-18', '2019-12-18', 'user', NULL, NULL, 9, '(555)555-5555', 1, 'coltlooper@gear.com');
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`, `role`, `image_url`, `about`, `address_id`, `phone`, `enabled`, `username`) VALUES (10, 'Adam', 'Onwan', 'adamonwan@gear.com', 'gear', '2019-12-18', '2019-12-18', 'user', NULL, NULL, 10, '(555)555-5555', 1, 'adamonwan@gear.com');
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`, `role`, `image_url`, `about`, `address_id`, `phone`, `enabled`, `username`) VALUES (11, 'Brian', 'Streetman', 'brianstreetman@gear.com', 'gear', '2019-12-18', '2019-12-18', 'user', NULL, NULL, 11, '(555)555-5555', 1, 'brianstreetman@gear.com');
